...
const settings = {
  ...
  const greeting = {
    ...
    subTitle:
      "Results-driven IT professional with a strong focus on cloud computing, infrastructure management, and system architecture. Proficient in PowerShell scripting and Terraform, I excel in crafting efficient and automated solutions.",
    resumeLink:
      "https://drive.google.com/drive/folders/1bZ7du3Tk--2u8cRYlXGBF5iyPX07nK0K?usp=sharing",
    ...
    data: [
        {
            ...
            skills: [
              ...
              "⚡Managed and optimized Azure Firewall, implementing automation for updates and auto-scaling to bolster security and performance while reducing operational overhead.",            
            ],
            softwareSkills: [
               {
                    skillName: "Azure",
          ...
          },
          {
            ...
            skills: [
              "⚡Crafted impactful Power BI reports by harnessing data from Log Analytics Workspace, enabling data-driven insights and automated data refreshing at 30-minute intervals, empowering teams to make data-backed decisions.",
  ...
  const contactPageData = {
    contactSection: {
      title: "Contact Me",
      profile_image_path: "animated_junaid.png",
      description:
